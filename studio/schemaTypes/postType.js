...
export const postType = defineType({
  ...
  fields: [
    ...
    defineField({name: 'tags', title: 'Tags', type: 'array', of: [{type: 'string'}], options: {layout: 'tags'}, group: 'main'}),
    ...
    defineField({name: 'relatedPosts', title: 'Related blogs', type: 'array', of: [{type: 'reference', to: [{type: 'post'}]}], group: 'meta'}),
    defineField({name: 'relatedTreatments', title: 'Related treatments', type: 'array', of: [{type: 'reference', to: [{type: 'treatment'}]}], group: 'meta'}),
    defineField({name: 'seo', title: 'SEO', type: 'seoFields', group: 'meta'}),
  ],
