...
export const homePageType = defineType({
  ...
  fields: [
    ...
    defineField({name: 'expertiseEyebrow', title: 'Expertise eyebrow', type: 'string', group: 'sections'}),
    defineField({name: 'expertiseHeading', title: 'Expertise heading', type: 'string', group: 'sections'}),
    defineField({name: 'expertiseDescription', title: 'Expertise description', type: 'text', rows: 2, group: 'sections'}),
    defineField({name: 'whyChooseEyebrow', title: 'Why choose eyebrow', type: 'string', group: 'sections'}),
    defineField({name: 'whyChooseHeading', title: 'Why choose heading', type: 'string', group: 'sections'}),
    defineField({name: 'whyChooseDescription', title: 'Why choose description', type: 'text', rows: 2, group: 'sections'}),
    defineField({name: 'whyChooseImage', title: 'Why choose image', type: 'mediaImage', group: 'sections'}),
