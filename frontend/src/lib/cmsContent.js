...
const CMS_QUERY = `{
  ...
  "categories": *[_type == "category"]|order(order asc, title asc){
    ...
    "services": *[_type == "treatment" && references(^._id) && status != "draft"]|order(order asc, title asc){
      _id, title, short, heroTitle, pageTitle, hero, description, overviewHeading, whatHeading, idealCandidateHeading, ctaText, ctaLink, what, whoFor,
      procedureHeading, processHeading, benefitsHeading, resultsHeading,
      whyChooseHeading, whyChooseDescription, whyChooseItems,
      specialistHeading, specialistDescription, specialistHighlights, faqHeading,
      costHeading, costDescription, priceFrom, pricing, "benefits": benefits[]{
  title,
  description,
  "icon": {
    "url": coalesce(
...
const mergeSite = (site = {}) => ({
  ...
  logoUrl: FALLBACK_SITE.logoUrl,
  footerLogoUrl: FALLBACK_SITE.footerLogoUrl,
  doctorPortraitUrl: FALLBACK_SITE.doctorPortraitUrl,
  heroImageUrl: FALLBACK_SITE.heroImageUrl,
  clinicPhotoUrl: FALLBACK_SITE.clinicPhotoUrl,
  heroVideoUrl: FALLBACK_SITE.heroVideoUrl,
...
const normalizeService = (service, category) => {
  ...
  return {
    ...
    whatHeading: service.whatHeading || "",
    idealCandidateHeading: service.idealCandidateHeading || "",
    ctaText: service.ctaText || "",
    ctaLink: service.ctaLink || "",
    procedureHeading: service.procedureHeading || "",
    processHeading: service.processHeading || "",
    benefitsHeading: service.benefitsHeading || "",
    resultsHeading: service.resultsHeading || "",
    whyChooseHeading: service.whyChooseHeading || "",
    whyChooseDescription: service.whyChooseDescription || "",
    whyChooseItems: service.whyChooseItems || [],
    specialistHeading: service.specialistHeading || "",
    specialistDescription: service.specialistDescription || "",
    specialistHighlights: service.specialistHighlights || [],
    faqHeading: service.faqHeading || "",
    costHeading: service.costHeading || "",
