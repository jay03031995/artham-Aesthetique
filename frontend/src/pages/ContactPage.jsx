    ...
    <>
      ...
      <section className="bg-[#f5e6d0] pt-16 pb-14 lg:pt-24 lg:pb-20">
        <div className="container-editorial max-w-4xl">
          ...
          <h1 className="font-display leading-[1.05] text-[#3D2F23]" style={{ fontSize: "clamp(2.5rem, 5vw, 3.75rem)" }}>Come, sit with us.</h1>
          <p className="text-body-lg text-[#5C4A38] max-w-xl mt-4">The easiest way is a call or a WhatsApp — we usually reply within a few minutes.</p>
        </div>
      </section>
          ...
          <div>
            ...
            <div className="space-y-5 mb-8">
              ...
              <div className="flex gap-4">
                ...
                <a data-testid="contact-wa" href={whatsAppLink()} target="_blank" rel="noreferrer" className="text-body link-gold">WhatsApp us</a>
              </div>
              <div className="flex gap-4">
              ...
              <div className="flex gap-4">
                ...
                <a href="mailto:hello@arthamaesthetique.com" className="text-body link-gold">hello@arthamaesthetique.com</a>
              </div>
            </div>
